	...
	Replication package
	Table A.12.  Main estimates using a Logit model
...
cap log close
log using "Logs/Table A12.smcl", replace
...
********************************************************************************
	...
	*Estandarizar los puntajes
	...
	mat list table1 
	putexcel set "Results\Tables paper matrices replication.xls", sheet("Raw Table A12") modify
