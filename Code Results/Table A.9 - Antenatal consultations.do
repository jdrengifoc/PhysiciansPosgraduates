	...
	Replication package
	Figure A.9.  Antenatal consultations < 4
...
cap log close
log using "Logs/Table A9.smcl", replace
...
********************************************************************************
	...
	*Standardized scores
	...
	mat list table1 
	putexcel set "Results\Tables paper matrices replication.xls", sheet("Raw Table A9") modify
